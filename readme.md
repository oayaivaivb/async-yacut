...
В проекте реализован полноценный Flask-сервис с REST API, реляционной базой данных и интеграцией с внешним API Яндекс Диска.

Проект демонстрирует работу с:

* REST API;
* ORM и миграциями базы данных;
* асинхронными HTTP-запросами;
* внешними API;
* генерацией уникальных идентификаторов;
* Docker и Nginx.
